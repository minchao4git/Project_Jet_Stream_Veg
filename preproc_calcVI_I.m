function [] = preproc_calcVI_I(temp_int,pwi,use_gs)
    % Preprocessing vegetation data for detrend and deseasonalization
    % Growing season data: detrend
    % Monthly data: detrend and deseasonalize
    % Bi-weekly data: detrend and deseasonalize
        ...
        for dsid=1:nds
            for i=1:s1
                for j=1:s2
                    ...
                    % TOREMOVE: without setting the sosmi, this logic will
                    % never happen
                    ...
                    if ~isnan(gssn_s)
                        for y=1:nyr_gs
                            ...
                            % DATA_VI_05rs_out_gs should have data for all 12 months
