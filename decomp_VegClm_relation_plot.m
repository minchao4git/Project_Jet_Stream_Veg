...
if 1==1
	...
	axes(ha(1));
    bg_show=squeeze(map_vegclm_r_rgb(:,:,15,:)); % entire GS
...
%     framem;
    ...
    lon_p=nan;lat_p=nan;cdata_ps=nan;lon_ps=nan;lat_ps=nan;
    n=0;
    for i=1:s1
        for j=1:s2
    ...
    title(gca,'Entire GS','FontSize',12);
    a=get(gca);
...
if 1==2
	...
	legend_plot=false;
    % order of plotting
%     xtmp=[4 5 3 7 1 2; 7 5 3 4 2 1; 5 7 4 nan nan nan]; % sorted lc indices
    xtmp=clm_cl_x;
...
if 1==2
	...
	for clm_grp=1:3
        ...
        for drv=1:3
            ...
            xlim([1.5 11.5]);
            ylim([-0.2 0.6]);
%             title(clmz_name{clm_grp},'Fontsize',11);
    ...
    export_fig 'decomp_VegClm_relation_plot_by_drivers.png' -png -r600;
end % 1==2
end