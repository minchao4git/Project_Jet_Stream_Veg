...
% 	title_s={'Entire GS', 'SOS','+1 mon.','+2 mon.','+3 mon.','+4 mon.','+5 mon.'};
...
%     export_fig 'dom_clminx_plot_gs_supp_NDVI-VIP.png' -png -r300;
    export_fig 'dom_clminx_plot_gs_supp_GIMMS-NDVI_0.5deg.png' -png -r600;
end