function JLI_CLIM_Veg_SI_simplified()
    ...
    for lag=1:1
        ...
        for m=13:14
            mi=mi+1;
            for v=1:3 % % Temp., Radiation, Soil moisture, EVI2
    ...
    %             plotm(b(:), a(:), 'Color',[80 80 80]/255,'LineStyle','none', 'Marker', '+', 'MarkerSize',3);
                ...
                gca_w = (a.XLim(2)-a.XLim(1));
                gca_h = (a.YLim(2)-a.YLim(1));
                text(a.XLim(1)+gca_w*xscal, a.YLim(1)+gca_h*yscal,labels{(v-1)*2+mi},'FontSize',11,'FontName','Arial');
